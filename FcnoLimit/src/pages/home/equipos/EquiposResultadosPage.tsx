...
const EquiposResultadosPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // Traer partidos jugados por el equipo
    fetch(`${apiBaseUrl}/api/partidos/historial/equipo/${equipoId}`)
        ...
        <div className="equipos-content" style={{ maxWidth: 'none', margin: 0, width: '100%', minHeight: '100vh', padding: 0 }}>
          ...
          <div className="equipo-tabs">
            ...
            <button
              ...
              onClick={() => {
                if (equipoId) localStorage.setItem('equipoId', equipoId.toString());
                history.push(`/equipos/${equipoId}/partidos`);
              }}
            >
              Partidos
            </button>
            <div className="equipo-tab active">Resultados</div>
          </div>
