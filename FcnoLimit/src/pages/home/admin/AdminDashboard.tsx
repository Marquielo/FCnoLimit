...
const AdminDashboard: React.FC = () => {
  ...
  useEffect(() => {
    ...
    } else if (selected === "partidos-jugados") {
      setLoading(true);
      fetch("https://fcnolimit-back.onrender.com/api/partidos/jugados/detalle")
        .then(res => res.json())
        .then(data => {
          const partidosOrdenados = Array.isArray(data)
  ...
  // Función para navegar a AdminPartidos with partido data
      ...
      <IonContent fullscreen className="admin-dashboard-bg">
        <div className="admin-dashboard-flex elegant-admin">
          <aside className="admin-sidebar elegant-sidebar">
            ...
            <IonButton
              expand="block"
              className={`sidebar-btn ${selected === "partidos-jugados" ? "active" : ""}`}
              onClick={() => setSelected("partidos-jugados")}
            >
              <span className="sidebar-btn-icon">
            ...
            <IonButton
              ...
              onClick={() => {
                setSelected("crear-partido");
                history.push("/admin/crear-partido");
              }}
            >
              <span className="sidebar-btn-icon">
                <IonIcon icon={calendarOutline} />
            ...
            <IonButton
              expand="block"
              className={`sidebar-btn ${selected === "solicitudes" ? "active" : ""}`}
          ...
          <main className="admin-main-content elegant-main">
            <div className="admin-section-title">
              ...
              <h2>
                {selected === "partidos" && "Partidos pendientes por fecha"}
                {selected === "partidos-jugados" && "Partidos jugados"}
                {selected === "crear-partido" && "Crear Partido"}
                {selected === "solicitudes" && "Solicitudes"}
              </h2>
            </div>
            {loading && (
